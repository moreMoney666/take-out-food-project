<template>
  <div>
     <!-- 走马灯 -->
      <el-carousel :interval="4000" type="card" height="250px" style="width:%; margin:0 auto;">
    ...
    <!-- 添加餐厅 -->
    <el-button type="primary" icon="el-icon-plus" style="margin-left:40px; margin-top:40px;"  @click="showAddDialog" >添加餐馆</el-button>
     
      <!-- 添加”和“修改”弹出el-dialog（对话框） -->
      <!-- 在这里自动收集表单数据 -->
    <el-dialog :title="newrestantListForm.id?'修改餐馆':'添加餐馆'" :visible.sync="isShowDialog">

     <el-form :model="newrestantListForm" style="width:80%" :rules="rules" ref="newrestantListForm">

       <el-form-item label="店铺名称" label-width="100px" prop="name">
        <el-input v-model="newrestantListForm.name" autocomplete="off"></el-input>
      </el-form-item>

      <el-form-item label="店铺地址" label-width="100px" prop="address">
         <el-input v-model="newrestantListForm.address" autocomplete="off"></el-input>
      </el-form-item>

          <el-form-item label="食品分类" label-width="100px" prop="category">
      <el-input v-model="newrestantListForm.category" autocomplete="off"></el-input>
         </el-form-item>

       <el-form-item label="店铺电话" label-width="100px" prop="phone">
      <el-input v-model="newrestantListForm.phone" autocomplete="off"></el-input>
         </el-form-item>
    </el-form>
    ...
    <el-table style="width:92%;margin:40px auto" border :data="newrestantList">
      <el-table-column label="序号" type="index" width="80" align="center">
      </el-table-column>
      <el-table-column label="餐馆名称" prop="name">
      ...
      <el-table-column label="操作">
        <template slot-scope="{ row, $index }">
          <!-- 修改餐厅 -->
         <el-button type="danger" icon="el-icon-delete" round  size="mini" @click="showUpdateDialog(row, $index)">    
            修改
         </el-button>
         <!-- 删除餐厅 -->
         <el-button type="danger" icon="el-icon-delete" round  size="mini" @click="deleteTrademark(row)">      
            删除
          </el-button>
        </template>
      </el-table-column>
...
methods:{
    ...
    async getresrantList(){
        try{
            const result = await this.$API.restrant.getresrant();
            if(result){
